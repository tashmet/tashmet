...
function load(loaders, data, absPath, query, cb) {
...
function serialize(loaders, data, absPath, query, cb) {
  async.eachSeries(loaders.reverse(), function(loader, done) {
...
Resource.prototype.get = function(query, cb) {
  ...
  getPath(query, this.params, this.pattern, cb, function(absPath) {
    fs.readFile(absPath, 'utf-8', function(err, data) {
      if(!err) {
        load(loaders, data, absPath, query, function(err, data) {
...
Resource.prototype.store = function(query, data, cb) {
  ...
  getPath(query, this.params, this.pattern, cb, function(absPath) {
    serialize(loaders, data, absPath, query, function(err, data) {
      if(!err) {
