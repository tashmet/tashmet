...
function TaxonomyService(rest, storage, cache, yaml, sync, pipe) {
  ...
  sync.collection('taxonomies', collection);
 ...
 */
exports = module.exports = function(rest, storage, cache, yaml, sync, pipe) {
  return new TaxonomyService(rest, storage, cache, yaml, sync, pipe);
};
